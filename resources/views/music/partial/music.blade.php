...
<div id="menu-{{ $key }}"
     class="z-50 hidden my-4 text-base list-none backdrop-blur-3xl bg-white/30 dark:bg-black/30 divide-y divide-gray-100 rounded-lg shadow-2xl">
    <ul class="py-2 font-medium" role="none">
        ...
        <li>
            <button type="button"
                    class="px-4 py-2 text-sm text-red-500 hover:backdrop-blur-3xl cursor-pointer w-full flex justify-start"
