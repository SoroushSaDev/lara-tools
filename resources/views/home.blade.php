...
@section('content')
    <div class="grid grid-cols-2 lg:grid-cols-3 gap-3 lg:gap-6 mt-5 lg:mt-0">
        <a href="{{ route('notes.index') }}"
           class="flex flex-col justify-center items-center space-y-5 lg:space-y-10 font-semibold text-lg lg:text-2xl p-10 lg:p-20 backdrop-blur-3xl bg-white/30 dark:bg-black/30 rounded-lg hover:shadow-2xl">
